    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-[#1E293B] rounded-2xl shadow-xl w-full max-w-md border dark:border-slate-700/60">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-700/60">
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/40 text-slate-500 dark:text-slate-400">
            <X className="h-4 w-4" />
          </button>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full h-9 px-3 border border-slate-200 dark:border-slate-700/60 rounded-lg text-sm bg-white dark:bg-[#1E293B] dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            <div className="space-y-1">
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="flex items-center gap-1 bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-slate-700/60 rounded-lg px-1 py-1">
          <button
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all ${
                c.id === categoryFilter
                  ...
                  : 'bg-white dark:bg-[#1E293B] text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700/60 hover:border-blue-300 dark:hover:border-blue-600 hover:text-blue-600 dark:hover:text-blue-400'
              }`}
            >
              {c.name}
