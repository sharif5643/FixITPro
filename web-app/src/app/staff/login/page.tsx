          ...
          <div className={`transition-all duration-700 delay-150 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-semibold text-slate-500">อีเมล</label>
              ...
              <div className="flex items-center justify-between">
                <button type="button" onClick={() => setRemember(v => !v)} className="flex items-center gap-2">
                  <div className="flex h-5 w-5 items-center justify-center rounded-md border-2 transition-all"
                    style={{ borderColor: remember ? '#FFC107' : '#E5E7EB', backgroundColor: remember ? '#FFC107' : 'white' }}>
                    {remember && (
                ...
                <button type="button" onClick={() => { setForgotEmail(emailVal ?? ''); setShowForgot(true) }}
              ...
              {/* Social login — hidden in WebView APK (Google blocks OAuth in WebView) */}
              {!isInWebViewApp() && (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button type="button" onClick={() => { window.location.href = '/api/v1/auth/line' }}
            ...
            {tempPw ? (
              ...
              <>
                <div className="flex items-center justify-between mb-5">
                  <p className="text-base font-bold text-brand-black">ลืมรหัสผ่าน</p>
                  <button onClick={closeForgot} className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F8F9FB]">
                ...
                <form onSubmit={handleForgotSubmit} className="flex flex-col gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="h-12 w-full rounded-xl border border-slate-200 bg-[#F8F9FB] pl-10 pr-4 text-sm outline-none focus:border-brand-yellow focus:ring-2 focus:ring-brand-yellow/20"
                    />
                  </div>
